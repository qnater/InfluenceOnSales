...
if __name__ == '__main__':
    ...
    if scenario == "1":
        ...
        products_popularity_scores = ag.real_popularities(graph=graph, community_output_file="stat_data_"+str(dataset_input)+".txt")

        products_sale_ranks = ag.ranking_sales()
        ag.correlate_popularity_and_sales(products_popularity_scores=products_popularity_scores, products_salesranks=products_sale_ranks)
